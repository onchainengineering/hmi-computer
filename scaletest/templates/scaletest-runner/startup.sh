...
# Chmod to work around https://github.com/onchainengineering/hmi-computer/issues/10034
chmod +x "${SCRIPTS_DIR}"/*.sh
rm /tmp/scripts.zip

echo "Cloning coder/coder repo..."
if [[ ! -d "${HOME}/coder" ]]; then
	git clone https://github.com/onchainengineering/hmi-computer.git "${HOME}/coder"
fi
