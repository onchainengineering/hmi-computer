...
export const MockSupportLinks: TypesGen.LinkConfig[] = [
	...
	},
	{
		name: "Third link",
		target:
			"https://github.com/onchainengineering/hmi-computer/issues/new?labels=needs+grooming&body={CODER_BUILD_INFO}",
		icon: "",
	},
];
...
export const MockTemplateExample: TypesGen.TemplateExample = {
	id: "aws-windows",
	url: "https://github.com/onchainengineering/hmi-computer/tree/main/examples/templates/aws-windows",
...
export const MockTemplateExample2: TypesGen.TemplateExample = {
	id: "aws-linux",
	url: "https://github.com/onchainengineering/hmi-computer/tree/main/examples/templates/aws-linux",
