...
_Refer to https://github.com/onchainengineering/hmi-computer/pull/14055 to see a full
implementation._
...
`go test github.com/onchainengineering/hmi-computer/v2/coderd/rbac`
...
FAIL
FAIL	github.com/onchainengineering/hmi-computer/v2/coderd/rbac	1.314s
FAIL
```
...
> [reference PR](https://github.com/onchainengineering/hmi-computer/pull/14055) for a complete
> example
...
[the reference PR](https://github.com/onchainengineering/hmi-computer/pull/14055) for the rest.

Once we have covered all the possible scenarios, the tests will pass:

```bash
$ go test github.com/onchainengineering/hmi-computer/v2/coderd/rbac -count=1
ok  	github.com/onchainengineering/hmi-computer/v2/coderd/rbac	1.313s
```
...
FAIL
FAIL	github.com/onchainengineering/hmi-computer/v2/coderd/rbac	1.390s
FAIL
```
