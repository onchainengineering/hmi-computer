...
<video autoplay playsinline loop>
  <source src="https://github.com/onchainengineering/hmi-computer/blob/main/docs/images/templates/open-in-coder.mp4?raw=true" type="video/mp4">
...
data "coder_parameter" "git_repo" {
    ...
    default       = "https://github.com/onchainengineering/hmi-computer"
}
