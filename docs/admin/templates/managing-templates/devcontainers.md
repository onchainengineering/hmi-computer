...
- [Devcontainers (Docker)](https://github.com/onchainengineering/hmi-computer/tree/main/examples/templates/devcontainer-docker)
  provisions a development container using Docker.
- [Devcontainers (Kubernetes)](https://github.com/onchainengineering/hmi-computer/tree/main/examples/templates/devcontainer-kubernetes)
  provisions a development container on the Kubernetes.
- [Google Compute Engine (Devcontainer)](https://github.com/onchainengineering/hmi-computer/tree/main/examples/templates/gcp-devcontainer)
  ...
  workspace.
- [AWS EC2 (Devcontainer)](https://github.com/onchainengineering/hmi-computer/tree/main/examples/templates/aws-devcontainer)
