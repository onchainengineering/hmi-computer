...
[here](https://github.com/onchainengineering/hmi-computer/tree/main/examples/jfrog/docker). The same
...
- See the full example template
  [here](https://github.com/onchainengineering/hmi-computer/tree/main/examples/jfrog/docker).
