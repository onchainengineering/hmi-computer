...
using Coder's [JFrog Xray Integration](https://github.com/onchainengineering/hmi-computer-xray).
...
[`coder-xray`](https://github.com/onchainengineering/hmi-computer-xray) will scan all kubernetes
