...
> [here](https://github.com/onchainengineering/hmi-computer/blob/main/SECURITY.md).
...
| --------------------------------------------------------------------------------------------------------------------------------------------- | -------- | -------------------------------------------------------------- | ------------------- |
| [API tokens of deleted users not invalidated](https://github.com/onchainengineering/hmi-computer/blob/main/docs/admin/security/0001_user_apikeys_invalidation.md) | HIGH     | [v0.23.0](https://github.com/onchainengineering/hmi-computer/releases/tag/v0.23.0) | v0.8.25 - v0.22.2   |
