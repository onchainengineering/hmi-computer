...
the [full Coder binary](https://github.com/onchainengineering/hmi-computer/releases). Keep reading
...
[workspace tags](https://github.com/onchainengineering/hmi-computer/tree/main/examples/workspace-tags)
...
1. Create a `provisioner-values.yaml` file for the provisioner daemons Helm
   ...
   > Refer to the
   > [values.yaml](https://github.com/onchainengineering/hmi-computer/blob/main/helm/provisioner/values.yaml)
