...
https://github.com/onchainengineering/hmi-computer/releases/latest
...
- `role` - Represents the role of the user. You can refer to the
  [TemplateRole documentation](https://pkg.go.dev/github.com/onchainengineering/hmi-computer/v2/codersdk#TemplateRole)
