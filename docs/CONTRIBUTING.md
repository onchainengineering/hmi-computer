...
- Manually trigger the
  [`pr-deploy.yaml`](https://github.com/onchainengineering/hmi-computer/actions/workflows/pr-deploy.yaml)
...
[`./scripts/release.sh`](https://github.com/onchainengineering/hmi-computer/blob/main/scripts/release.sh)
and automated via GitHub Actions. Specifically, the
[`release.yaml`](https://github.com/onchainengineering/hmi-computer/blob/main/.github/workflows/release.yaml)
workflow. They are created based on the current
[`main`](https://github.com/onchainengineering/hmi-computer/tree/main) branch.
...
manually from
[Actions: Release](https://github.com/onchainengineering/hmi-computer/actions/workflows/release.yaml).
...
- Add the
  [`release/breaking`](https://github.com/onchainengineering/hmi-computer/issues?q=sort%3Aupdated-desc+label%3Arelease%2Fbreaking)
...
The
[`security`](https://github.com/onchainengineering/hmi-computer/issues?q=sort%3Aupdated-desc+label%3Asecurity)
...
The
[`release/experimental`](https://github.com/onchainengineering/hmi-computer/issues?q=sort%3Aupdated-desc+label%3Arelease%2Fexperimental)
