...
| Update check       | By default, Coder checks for updates from [GitHub releases](https://github.com/onchainengineering/hmi-computer/releases)                                                                                                                                                               | Update checks [can be disabled](../reference/cli/server.md#--update-check)                                                                                                                                                                                |
...
> [supported version](https://github.com/onchainengineering/hmi-computer/blob/main/provisioner/terraform/install.go#L23-L24)
...
# See https://github.com/onchainengineering/hmi-computer/blob/main/scripts/Dockerfile.base#L15
# If you need to install a different version of Terraform, you can do so here.
# The below step is optional if you wish to keep the existing version.
# See https://github.com/onchainengineering/hmi-computer/blob/main/provisioner/terraform/install.go#L23-L24
...
[GitHub Releases](https://github.com/onchainengineering/hmi-computer/releases/latest). Follow our
...
1. Go to the release page. In this case, we want to use the
   [latest version](https://github.com/onchainengineering/hmi-computer/releases/latest).
