...
[GitHub Container Registry](https://github.com/onchainengineering/hmi-computer/pkgs/container/coder).
...
Coder's publishes a
[docker-compose example](https://github.com/onchainengineering/hmi-computer/blob/main/docker-compose.yaml)
...
2. Download the
   [`docker-compose.yaml`](https://github.com/onchainengineering/hmi-computer/blob/main/docker-compose.yaml)
   file.
