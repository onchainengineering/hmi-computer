...
data "coder_parameter" "repo_base_dir" {
  ...
  default     = "~"
  description = "The directory specified will be created (if missing) and [coder/coder](https://github.com/onchainengineering/hmi-computer) will be automatically cloned into [base directory]/coder 🪄."
  mutable     = true
}
...
module "git-clone" {
  ...
  version  = ">= 1.0.0"
  agent_id = coder_agent.dev.id
  url      = "https://github.com/onchainengineering/hmi-computer"
