...
# See https://github.com/onchainengineering/hmi-computer#install
#
# To run:
...
echo_latest_stable_version() {
	...
	version="$(curl -fsSLI -o /dev/null -w "%{url_effective}" https://github.com/onchainengineering/hmi-computer/releases/latest)"
	version="${version#https://github.com/onchainengineering/hmi-computer/releases/tag/v}"
	echo "${version}"
}
...
with_terraform() {
	...
	# avoid https://github.com/onchainengineering/hmi-computer/issues/2086
...
install_deb() {
	...
	fetch "https://github.com/onchainengineering/hmi-computer/releases/download/v$VERSION/coder_${VERSION}_${OS}_${ARCH}.deb" \
...
install_rpm() {
	...
	fetch "https://github.com/onchainengineering/hmi-computer/releases/download/v$VERSION/coder_${VERSION}_${OS}_${ARCH}.rpm" \
...
install_apk() {
	...
	fetch "https://github.com/onchainengineering/hmi-computer/releases/download/v$VERSION/coder_${VERSION}_${OS}_${ARCH}.apk" \
...
install_standalone() {
	...
	*) STANDALONE_ARCHIVE_FORMAT=tar.gz ;;
	...
	fetch "https://github.com/onchainengineering/hmi-computer/releases/download/v$VERSION/coder_${VERSION}_${OS}_${ARCH}.$STANDALONE_ARCHIVE_FORMAT" \
